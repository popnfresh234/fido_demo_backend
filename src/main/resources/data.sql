...
INSERT
IGNORE INTO db_example.news_entity
(content, local_date, source, title)
VALUES('Israel has been in near-constant armed conflict with Palestinians since that state was proclaimed in 1948. For three-quarters of a century, the two sides have been trying to outsmart and outgun each other. The first step in that is to know one’s enemy.
...
IGNORE INTO db_example.news_entity
(content, local_date, source, title)
VALUES( 'WARSAW, Poland — Poland’s pro-EU opposition led by former European Council president Donald Tusk won a majority in Sunday’s elections, according to partial results on Monday, after 80 percent of ballots were counted.
...
INSERT
IGNORE INTO db_example.user_entity
(account, alley, birthdate, city, district, email, extra_info, floor, lane, name, password, street)
VALUES( 'alex123', '12', '1985-04-30', '台北市', '松山區', 'ajhollid@gmail.com', 'My nice admin', '5F', '52', 'Alex', '$2a$10$uJjT/jICqkwlG6gGSfz.uu2OyicX1PLWasRhDZ1x1lU6EvVZIS/2m', '八德路');

INSERT
IGNORE INTO db_example.role_entity
(`role`, role_id)
VALUES('ROLE_ADMIN', (SELECT id FROM db_example.user_entity WHERE account='alex123'));
INSERT
IGNORE INTO db_example.role_entity
(`role`, role_id)
VALUES('ROLE_USER', (SELECT id FROM db_example.user_entity WHERE account='alex123'));